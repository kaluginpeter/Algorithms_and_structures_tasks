# The Problem
# Dan, president of a Large company could use your help. He wants to implement
# a system that will switch all his devices into offline mode depending on his meeting schedule.
...
#
# currentTime - is a string with specific time in hh:mm 24-h format for which the
# function will check availability based on the schedule.
#
...
# If Dan is in the middle of an appointment at currentTime, the function should return
# a string with the time he's going to be available.
# Examples
