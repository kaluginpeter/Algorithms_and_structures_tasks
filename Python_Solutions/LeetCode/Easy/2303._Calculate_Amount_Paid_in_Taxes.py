...
# And so on.
# You are given an integer income representing the amount of money you earned. Return the amount
# of money that you have to pay in taxes. Answers within 10-5 of the actual answer will be accepted.
#
# Example 1:
#
