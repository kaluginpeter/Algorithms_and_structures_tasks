# Cara is applying for several different jobs. The online application
...
#
# If her answer "text" is too long, return an array: [False, "Answer"]. The second element should be the original
# "text" string truncated to the length of the limit.
#
