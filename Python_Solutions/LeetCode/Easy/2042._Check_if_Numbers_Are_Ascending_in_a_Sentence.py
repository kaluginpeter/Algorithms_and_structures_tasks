...
# Every token is either a positive number consisting of digits 0-9 with no leading zeros, or
...
# numbers in s are strictly increasing from left to right (i.e., other than the last number,
