...
#
# We may see another cases, for numbers that have another two prime factors like:
# 5, 11, but bellow (or equal) a maximum value 1000
#
# 55 = 5 * 11
# 275 = 5^2 * 11
# 605 = 5 * 11^2
...
#
# Make the function highest_biPrimefac(), that receives two primes as arguments and
# a maximum limit , nMax(found numbers should be less or equal to nMax). Output should
# be a list or array of highest number found and the corresponding exponents of primes in order given.
