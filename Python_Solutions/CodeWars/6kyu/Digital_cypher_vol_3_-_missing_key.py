...
# Task
# Write a function that accepts a message string and an array of integers code.
# As the result, return the key that was used to encrypt the message.
# The key has to be shortest of all possible keys that can be used to code the message:
# i.e. when the possible keys are 12 , 1212, 121212, your solution should return 12.
#
# Input / Output:
