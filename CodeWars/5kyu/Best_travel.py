...
# list of distances between these towns. ls = [50, 55, 57, 58, 60]. John is tired of
# driving and he says to Mary that he doesn't want to drive more than t = 174 miles and he will visit only 3 towns.
...
# The function returns the "best" sum ie the biggest possible sum of k distances less than or
# equal to the given limit t, if that sum exists, or otherwise nil, null, None, Nothing,
# depending on the language. In that case with C, C++, D, Dart, Fortran, F#, Go, Julia,
# Kotlin, Nim, OCaml, Pascal, Perl, PowerShell, Reason, Rust, Scala, Shell, Swift return -1.
# Examples:
