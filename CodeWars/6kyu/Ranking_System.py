...
# The higher the number the higher the points. In the array [1,3,2] 3 is the
# highest point value so it gets 1st place. 2 is the second highest so it gets
# second place. 1 is the 3rd highest so it gets 3rd place.
#
