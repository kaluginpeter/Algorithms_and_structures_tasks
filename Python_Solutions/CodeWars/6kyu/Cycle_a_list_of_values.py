# Prologue
# You're part of a team porting MS Paint into the browser and currently working on
# a new UI component that allows user to control the canvas zoom level.
#
# According to the wireframes delivered to you in PowerPoint format the user should be
# able to cycle through specified zoom levels by clicking a button in the UI repeatedly.
...
#
# The function should pick the next value from the other side of the list in case there
# are no values in the given direction.
#
# Examples
