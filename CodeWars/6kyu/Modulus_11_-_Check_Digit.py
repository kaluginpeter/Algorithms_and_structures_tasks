...
# This is done by calculating a single-digit value based on the product number, and
# then appending that digit to the product number to arrive at the product code.
#
