...
# those that do not end in 1 are unhappy numbers (or sad numbers) (Wikipedia).
#
# Write a function that takes n as parameter and return true if and only if n is an happy number, false otherwise.
#
# Examples
# For example number 7 is happy because after a number of steps
# the computed sequence ends up with a 1: 7, 49, 97, 130, 10, 1
#
