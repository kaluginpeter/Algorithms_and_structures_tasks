...
# there was a napkin where he wrote a simple puzzle: "how many different squares are there in a grid of NxN squares?".
#
# For example, when N=2, the answer is 5: the 2x2 square itself, plus the four 1x1 squares in its corners:
#
#
# Task
# Complete the function that solves Feynman's question in general.
