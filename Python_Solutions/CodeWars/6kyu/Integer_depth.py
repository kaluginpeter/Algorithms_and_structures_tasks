...
# Hence it required 9 multiples of 42 to get all the digits. So the depth of 42 is 9. Write
# a function named computeDepth which computes the depth of its integer argument.Only positive
