...
# As an example, '..P....' means that nothing happens for two seconds, then the button is pressed,
# then no further events.
#
# Output
# A string where each character represents one second and indicates the position of
# the door (0 if fully closed and 5 fully open). The door starts moving immediately,
