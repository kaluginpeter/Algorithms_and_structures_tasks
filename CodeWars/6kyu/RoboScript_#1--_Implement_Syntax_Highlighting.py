...
#
# highlight("FFFR345F2LL"); // => "<span style=\"color: pink\">FFF</span><span style=\"color: green\">
# R</span><span style=\"color: orange\">345</span><span style=\"color: pink\">F</span><span style=\"color: orange\">2</span><span style=\"color: red\">LL</span>"
# Note that the use of <span> tags must be exactly the same format as demonstrated above.
# Even if your solution produces the same visual result as the expected answers, if you miss
# a space betwen "color:" and "green", for example, you will fail the tests.
#
# Kata in this Series
# RoboScript #1 - Implement Syntax Highlighting
