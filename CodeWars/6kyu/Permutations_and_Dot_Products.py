...
# Euclidean space), is an algebraic operation that takes two equal-length sequences of numbers
# (usually coordinate vectors) and returns a single number. Wikipedia
#
...
# Remarks
# If the list or array is empty, minDot should return 0. All arrays or lists will have
# the same length. Also, for the dynamically typed languages, all inputs will be valid lists or arrays,
# you don't need to check for undefined, null etc.
#
