# Given an array (or list) of scores, return the array of
# ranks for each value in the array. The largest value has rank 1,
# the second largest value has rank 2, and so on. Ties should be
