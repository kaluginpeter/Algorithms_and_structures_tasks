...
# of letters in "sixzero" is seven. The number of letters in "seven" is five.
...
# word (instead of the proper name of the number in English). For example, write 12
# as "onetwo" (instead of twelve), and 999 as "nineninenine" (instead of nine hundred and ninety-nine).
#
