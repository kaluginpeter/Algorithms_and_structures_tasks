# DefaultList
# The collections module has defaultdict, which gives you a default value
# for trying to get the value of a key which does not exist in the dictionary
...
#
# Because slicing a list never raises an error (slicing a list between two indexes that are not
# a part of the list returns [], slicing will not be tested for.
#
# Example
#
