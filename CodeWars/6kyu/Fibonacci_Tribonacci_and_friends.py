...
# a Pentabonacci (well Cinquebonacci would probably sound a bit more italian, but it would
# also sound really awful) with a signature of 5 elements and each following element is
