...
# between two negative elements. No negative element should be present in the sum.
# If there is no such sum: -1 for Python, C++, JavaScript, Java, CoffeeScript and COBOL,
