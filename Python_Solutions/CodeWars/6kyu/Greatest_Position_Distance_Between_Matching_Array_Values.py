...
# between the matching '1' values at index 2 and 5. Executing greatestDistance
# against this array would return 3. (i.e. 5 - 2)
#
...
# I enjoyed solving the problem I thought it was asking me to complete so I thought I'd
