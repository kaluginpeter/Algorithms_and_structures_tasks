# Traditionally in FizzBuzz, multiples of 3 are replaced by "Fizz" and
# multiples of 5 are replaced by "Buzz". But we could also play FizzBuzz
...
# sequence will have a maximum length of 100. The Fizz and Buzz numbers might be equal, and might be equal to 1.
#
# Examples
